...
//This workerrole is for the process of the car price
namespace Car
{
    public class CarWorkerRole : RoleEntryPoint
    {
        ...
        private void initQueue()
        {
            ...
            inqueue = queueClient.GetQueueReference("carqueue");
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                if (inputMessage != null)
                {
                        ...
                        new ChannelFactory<IService1>(new WebHttpBinding(), "http://localhost:8000"))
                    {
                        ...
                        //go to interface and go to the carCost method that adds the flightCost and hotelCost
                        IService1 @interface = cf.CreateChannel();
                        carPrice = @interface.carCost(inputMessage.AsString);
                        ...
                        JObject jObject = new JObject { ["carCost"] = carPrice };
